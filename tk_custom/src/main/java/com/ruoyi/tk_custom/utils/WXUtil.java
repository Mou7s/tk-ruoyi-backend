...
public class WXUtil {
    ...
    public static String getToken() {
        ...
        String body = HttpRequest.get("https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=" + corpid + "&corpsecret=" + corpsecret).body();
...
//            System.out.println("老token");
        ...
        String body = HttpRequest.get("https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=" + corpid + "&corpsecret=" + corpsecret_TongXunLu).body();
        HashMap hashMap = new Gson().fromJson(body, HashMap.class);
...
//        System.out.println("重新获取token");
    ...
    public static ArrayList<JsonObject> getUserObjectListFrom_TongXunLu(int times) {
        HttpRequest httpRequest = HttpRequest.post("https://qyapi.weixin.qq.com/cgi-bin/user/list_id?access_token=" + getToken_TongXunLu()).acceptJson();
    ...
    public static JsonArray getDept(int times) {
        HttpRequest httpRequest = HttpRequest.post("https://qyapi.weixin.qq.com/cgi-bin/department/list?access_token=" + getToken()).acceptJson();
        HashMap<String, String> hp = new HashMap<>();
        if (times > 99)
            return null;
        times++;
    ...
    public static String createChatRoom() {
        HttpRequest httpRequest = HttpRequest.post("https://qyapi.weixin.qq.com/cgi-bin/appchat/create?access_token=" + getToken()).acceptJson();
        HashMap<String, String> hp = new HashMap<>();
    ...
    public static String getUserNamebyId(String id) {
        String body = HttpRequest.get("https://qyapi.weixin.qq.com/cgi-bin/user/get?access_token=" + getToken() + "&userid=" + id).body();
    ...
    public static void uploadFileToWechat(String path, String roomid) throws FileNotFoundException {
        ...
        HttpPost httpPost = new HttpPost("https://qyapi.weixin.qq.com/cgi-bin/media/upload?access_token=" + getToken() + "&type=file&debug=1");
    ...
    public static String sendMsg(String id, String content) {
        HttpRequest httpRequest = HttpRequest.post("https://qyapi.weixin.qq.com/cgi-bin/message/send?access_token=" + getToken()).acceptJson();
        return httpRequest.send("{\n" +
                "   \"touser\" : \"" + id + "\",\n" +
                "   \"toparty\" : \"\",\n" +
                "   \"totag\" : \"\",\n" +
    ...
    public static String sendMsgToChatRoom(HashMap<String, Object> hp) {//88888888
        HttpRequest httpRequest = HttpRequest.post("https://qyapi.weixin.qq.com/cgi-bin/appchat/send?access_token=" + getToken()).acceptJson();
    ...
    public static ArrayList<WxApprove> getAllApproveData(long starttime, long endtime, ArrayList arrs, String new_cursor,String tempId) {
        HttpRequest httpRequest = HttpRequest.post("https://qyapi.weixin.qq.com/cgi-bin/oa/getapprovalinfo?access_token=" + getToken()).acceptJson();
    ...
    public static WxApprove getAndSaveApproveDetail(String detailID) {
        HttpRequest httpRequest = HttpRequest.post("https://qyapi.weixin.qq.com/cgi-bin/oa/getapprovaldetail?access_token=" + getToken()).acceptJson();
        String body = httpRequest.send("{\n" +
                "   \"sp_no\" : \"" + detailID + "\"\n" +
                "}").body();
        JsonObject jsonObject = new Gson().fromJson(body, JsonObject.class);
        ...
        wxApprove.setApplyDataContents(getApplyDataItemValue(info.getAsJsonObject("apply_data").get("contents").getAsJsonArray()));
    ...
    public static String getApplyDataItemValue(JsonArray arr) {
        ...
        for (JsonElement je : arr) {
            ...
            if ("Date".equals(control)) {
                long asLong = jb.get("value").getAsJsonObject().get("date").getAsJsonObject().get("s_timestamp").getAsLong();
            ...
            if ("Selector".equals(control)) {
                returnJb.put("needBack",
                        jb.get("value").getAsJsonObject().get("selector").getAsJsonObject().get("options").getAsJsonArray().get(0).getAsJsonObject().get("value").getAsJsonArray().get(0).getAsJsonObject().get("text").getAsString());
            }
            ...
            if ("Attendance".equals(control)) {
                JsonObject asJsonObject = jb.get("value").getAsJsonObject().get("attendance").getAsJsonObject().get("date_range").getAsJsonObject();
                JsonObject slice_info = jb.get("value").getAsJsonObject().get("attendance").getAsJsonObject().get("slice_info").getAsJsonObject();
                ...
                returnJb.put(jb.get("title").getAsJsonArray().get(0).getAsJsonObject().get("text").getAsString(),jsonObject.toString());
            }
    ...
    public static String downloadNet(String media_id) throws IOException {
        int bytesum = 0;
        int byteread;
        URL url = new URL("https://qyapi.weixin.qq.com/cgi-bin/media/get?access_token=" + getToken() + "&media_id=" + media_id + "");
